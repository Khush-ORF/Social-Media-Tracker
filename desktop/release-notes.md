...
Download **Social-Follower-Tracker-0.2.0-Windows-x64.exe** below and run it. No separate installation of Node.js, Chromium, or SQLite is needed. Internet access is required to collect fresh counts.
...
Windows 10/11 x64. This initial free release is not code-signed, so Windows may display an unknown-publisher warning. SHA256SUMS.txt provides the executable checksum.
